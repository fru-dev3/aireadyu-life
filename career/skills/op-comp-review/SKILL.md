...
10. If gap exists (TC below P50): call `task-flag-comp-gap` with gap amount, severity tier, market data sources, and recommended action.
...
13. Call `task-update-open-loops` with all flags from this run.

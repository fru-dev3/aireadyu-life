...
# aireadylife-career-market-scan
...
Runs monthly to ensure you always have a current read on the external market for your target roles — whether or not you are actively looking. It calls `aireadylife-career-scan-target-roles` to search LinkedIn, Glassdoor, and other configured job boards for postings matching your target criteria: role titles, company tier preferences, tech stack requirements, and compensation minimums. The op summarizes what it finds: how many relevant openings exist, the compensation ranges being offered, the most common required skills, and any notable patterns (e.g., specific companies hiring aggressively, new role titles emerging in the market). Openings that meet all target criteria are logged to vault/career/01_pipeline/ as "watch" stage items. This monthly pulse ensures you have leverage context at performance review time and can move quickly when a strong opportunity appears.

## Calls

- **Flows:** `aireadylife-career-scan-target-roles`

...
`~/Documents/AIReadyLife/vault/career/02_compensation/` — benchmark data cache
`~/Documents/AIReadyLife/vault/career/02_market/` — market comp range data from job postings

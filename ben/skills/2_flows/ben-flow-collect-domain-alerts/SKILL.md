...
that contain an open-loops.md file — this auto-discovery means ben works correctly regardless of
...
maintain vault/ben/config.md with an explicit plugin list if auto-discovery should be constrained
to specific domains.

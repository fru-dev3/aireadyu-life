...
**Trigger:** Called by `op-monthly-sync`, `op-trip-planning-review`
...
- **Trip record missing:** Cannot run. Return error to calling op: "Trip record not found in vault/explore/00_current/. Run task-log-trip to create one."

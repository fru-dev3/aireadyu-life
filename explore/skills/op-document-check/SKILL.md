...
2. Call `flow-check-travel-docs` with 12-month horizon and all travelers
...
7. For each document meeting flag criteria: call `task-flag-expiring-document`
...
10. Call `task-update-open-loops` to write all new flags

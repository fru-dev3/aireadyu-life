...
**Calendar coordination:** When a new trip is logged in vault/explore/00_current/, the Chief of Staff communicates the trip dates to the calendar plugin's open-loops.md so they appear as deadline items in the weekly agenda. Pre-trip preparation milestones (last day to apply for a visa, last day to book required vaccinations, 48-hour online check-in opening) are also surfaced as calendar domain items so they appear in the weekly agenda scan.

...
5. Call `task-flag-falling-behind` for each behind item with full pace data.
...
8. Call `flow-build-reading-summary` — get reading pace and annual goal projection.
...
11. Call `task-update-open-loops` with all flagged items.

...
1. Confirm enrollment window dates from `vault/benefits/00_current/` or user input. Call `task-flag-enrollment-window` with start and end dates.
...
14. Call `task-update-open-loops` with enrollment deadline and recommended actions.

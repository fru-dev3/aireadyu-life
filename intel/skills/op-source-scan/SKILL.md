...
10. Call `task-update-open-loops` if any priority topic has zero Tier 1 coverage
...
- If source-list.md is empty: "No sources configured. Add sources using task-log-source before running a source scan."

...
4. Check vault/intel/00_sources/source-list.md for a duplicate entry (same name or same primary URL); if found, offer to update the existing entry instead
...
Entry added to `~/Documents/AIReadyLife/vault/intel/00_sources/source-list.md`:
```
---
name: {Source Name}
...
- `source_list_path` — path to source-list.md (default: vault/intel/00_sources/source-list.md)
...
- Writes to: `~/Documents/AIReadyLife/vault/intel/00_sources/source-list.md`

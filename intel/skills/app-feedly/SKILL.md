...
```
app-feedly_api_key: YOUR_FEEDLY_API_KEY
app-feedly_user_id: YOUR_FEEDLY_USER_ID
app-feedly_chrome_profile: /Users/YOU/Library/Application Support/Google/Chrome/Default
```

## Key API (Feedly Developer — Pro+)

```
GET https://cloud.app-feedly.com/v3/streams/contents?streamId=user/{userId}/category/global.all

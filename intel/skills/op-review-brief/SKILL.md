...
2. Call `flow-build-news-digest` for today's filtered, ranked digest
...
9. Call `task-update-open-loops` if any new priority flags were generated
...
Same as op-daily-briefing. No additional configuration required.

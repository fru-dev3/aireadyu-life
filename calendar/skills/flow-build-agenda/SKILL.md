...
- Deadline items list (from flow-collect-deadlines, via calling op)
- Calendar event data and available focus slots (from flow-analyze-focus-time, via calling op)

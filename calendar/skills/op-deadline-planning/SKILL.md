...
9. Call `task-add-deadline` to register the deadline in vault/calendar/00_current/
10. Write milestone schedule to vault/calendar/00_current/YYYY-MM-DD-{slug}.md
11. Write deadline item to vault/calendar/open-loops.md via `task-update-open-loops`

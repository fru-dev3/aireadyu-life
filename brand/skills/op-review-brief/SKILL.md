...
2. Locate most recent brand synthesis in vault/brand/00_current/synthesis-{YYYY-MM}.md; if current month not found, call `op-monthly-synthesis` first
...
Same as op-monthly-synthesis. No additional configuration required.

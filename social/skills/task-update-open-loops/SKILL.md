...
1. Receive new flags from calling op (overdue app-contacts, birthday alerts, follow-up promises)
...
_Read by: Chief plugin (morning brief), op-review-brief, op-relationship-review_
...
- **File grows beyond 30 active items:** Flag: "Social open loops growing — schedule a monthly sync to process overdue app-contacts and close follow-up promises."

...
2. Verify contact name exists in vault/social/00_current/app-contacts.md; if not found, ask to confirm spelling or add as new contact
...
- ~/Documents/aireadylife/vault/social/00_current/app-contacts.md (for contact verification)
...
No configuration required. Contact name must match vault/social/00_current/app-contacts.md entries for health calculation to work correctly.

## Error Handling

- **Contact name not found in app-contacts.md:** Ask user: "I don't see [name] in your contact roster. Would you like to add them as a new contact first, or is this a different spelling?" Do not log to an unmatched contact name — the health calculations require exact name matching.
...
- Reads from: ~/Documents/aireadylife/vault/social/00_current/app-contacts.md

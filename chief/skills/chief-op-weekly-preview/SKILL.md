...
**Produces:** Weekly agenda written to vault/chief/02_agenda/ with cross-domain deadlines, priorities, and focus time recommendations
...
weekly agenda to vault/chief/02_agenda/ and calls check-open-loops to surface the total count of
...
vault/chief/02_agenda/ if the user wants to set manual priorities that take precedence over
auto-generated ones.

## Calls

- **Flows:** `aireadylife-chief-build-weekly-agenda`, `aireadylife-chief-collect-domain-alerts`
- **Tasks:** `aireadylife-chief-check-open-loops`
...
`vault/chief/02_agenda/week-{date}.md`

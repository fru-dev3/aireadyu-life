...
description: >
  ...
  chief-agent for brief output and daily note management. Configure integration
  token and page IDs in vault/chief/config.md.
---
...
**Configuration:** Set your token and page IDs in `vault/chief/config.md`
...
- `aireadylife-chief-daily-brief` — write formatted daily brief to Notion page

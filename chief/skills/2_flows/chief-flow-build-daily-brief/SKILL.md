...
**Trigger:** Called by `aireadylife-chief-daily-brief`
**Produces:** Fully formatted daily brief document ready to write to vault/chief/00_briefs/
...
🔴 item to ensure cross-domain urgent items are preserved in vault/chief/01_alerts/.

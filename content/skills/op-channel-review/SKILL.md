...
2. Call `flow-analyze-channel-performance` for cross-channel performance table, 90-day baseline comparison, and underperformance flags
...
11. Call `task-update-open-loops` with all underperformance flags and cadence misses

...
2. Call `flow-check-compliance-status` to evaluate all checklist items and return status table
...
10. Call `task-update-open-loops` with all 🔴 and 🟡 items

...
1. Read `~/Documents/AIReadyLife/vault/business/03_compliance/compliance-checklist.md`; parse each obligation into: name, frequency, last-completed date, next-due date
...
4. For each item marked complete, check vault/business/03_compliance/ for a matching backing document; flag "verify — no documentation" if none found
...
- `~/Documents/AIReadyLife/vault/business/03_compliance/compliance-checklist.md` — master list of all entity obligations with frequencies and dates
- `~/Documents/AIReadyLife/vault/business/03_compliance/` — backing documentation files (annual report confirmations, registered agent receipts, etc.)
...
Required fields in `~/Documents/AIReadyLife/vault/business/03_compliance/compliance-checklist.md`:
...
- If compliance-checklist.md does not exist: return "Compliance checklist not found at vault/business/03_compliance/compliance-checklist.md. Create this file to enable compliance tracking." Include a template structure.
...
- Reads from: `~/Documents/AIReadyLife/vault/business/03_compliance/compliance-checklist.md`, `~/Documents/AIReadyLife/vault/business/03_compliance/`, `~/Documents/AIReadyLife/vault/business/config.md`

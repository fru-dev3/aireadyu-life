...
2. Call `flow-build-pipeline-summary` to get stage breakdown, weighted value, stale list, conversion rate, and MoM comparison
...
8. Call `task-update-open-loops` with stale proposal follow-ups and pipeline health flags

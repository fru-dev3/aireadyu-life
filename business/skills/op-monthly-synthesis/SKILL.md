...
3. Call `flow-build-pl-summary` for the month's P&L with MoM comparison
...
7. Call `flow-check-compliance-status` for all entities; surface any items due within 60 days
...
12. Call `task-update-open-loops` with any new flags
